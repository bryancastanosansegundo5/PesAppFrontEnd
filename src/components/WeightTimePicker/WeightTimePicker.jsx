...
const estilosWheel = {
  root: 'rounded-[22px] border border-neon-cyan/25 bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(240,249,255,0.92))] shadow-[0_12px_32px_rgba(15,23,42,0.12)] dark:border-white/10 dark:bg-[linear-gradient(180deg,rgba(8,13,24,0.98),rgba(4,7,16,0.96))]',
  ...
  overlayBottom: 'from-[#eff6ff] via-white/92 to-transparent dark:from-[#030407] dark:via-[#08111f]/92',
  indicator:
